<script>
  ...
  import SimpleChartSrc from './samples/SimpleChart.svelte?raw';
  import UpdateChartDataSrc from './samples/UpdateChartData.svelte?raw';
  import ChangeChartTypeSrc from './samples/ChangeChartType.svelte?raw';
  import ResponsiveChartsSrc from './samples/ResponsiveCharts.svelte?raw';
  import TriggerEventsFromChartSrc from './samples/TriggerEventsFromChart.svelte?raw';
  import ExportChartsSrc from './samples/ExportCharts.svelte?raw';
  import SimpleTimeseriesSrc from './samples/SimpleTimeseries.svelte?raw';
...
<div class="app">
  <header class="topbar">
    ...
    <span class="badge">Svelte 5 · Vite</span>
  </header>
...
<style>
  ...
  .topbar {
    display: flex; align-items: baseline; gap: 12px; padding: 8px 4px 20px;
  }
